...
splot './fortran/data_poisson-03-fortran.txt' using 1:2:(f($1,$2) - $3) with pm3d

set title "Python Error"
splot './python/data_poisson-03-python.txt' using 1:2:(f($1,$2) - $3) with pm3d
