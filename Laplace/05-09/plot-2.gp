...
# Top row – 3D surfaces
splot './fortran/data_poisson-02-fortran.txt' using 1:2:3 with pm3d
splot './python/data_poisson-02-python.txt' using 1:2:3 with pm3d
