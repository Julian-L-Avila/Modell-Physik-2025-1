...
# Top row – 3D surfaces
splot './fortran/data_poisson-03-fortran.txt' using 1:2:3 with pm3d
splot './python/data_poisson-03-python.txt' using 1:2:3 with pm3d
